      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          ...
          <div className="w-full md:w-1/2">
            <div className="mb-6">
              <div className="text-2xl font-bold mb-4">Engineering the Digital Revolution</div>
          ...
          <div className="w-full md:w-1/4">
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://sigma.se" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma AB</a></li>
                <li><a href="http://sigmacivil.se" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma Civil</a></li>
                <li><a href="http://sigmaconnectivity.se" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma Connectivity</a></li>
                <li><a href="http://sigmaindustryeastnorth.se/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma Industry East North</a></li>
                <li><a href="https://www.sigmaindustrysouth.se/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma Industry South</a></li>
                <li><a href="https://sigmaindustrywest.se/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma Industry West</a></li>
                <li><a href="http://sigma.software/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Sigma Software</a></li>
                <li><a href="http://danir.se" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Danir AB (Sigma Group owner)</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/4">
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                <li><a href="https://sigmatechnology.com/about/" className="text-gray-300 hover:text-white">About us</a></li>
                <li><a href="https://sigmatechnology.com/about/sustainability/" className="text-gray-300 hover:text-white">Sustainability</a></li>
                <li><a href="/services/" className="text-gray-300 hover:text-white">Our services</a></li>
                <li><a href="https://sigmatechnology.com/companies/" className="text-gray-300 hover:text-white">Companies</a></li>
                <li><a href="https://sigmatechnology.com/insights-library/" className="text-gray-300 hover:text-white">Insights library</a></li>
                <li><a href="https://sigmatechnology.com/open-positions/" className="text-gray-300 hover:text-white">Open positions</a></li>
                <li><a href="/career/" className="text-gray-300 hover:text-white">Career</a></li>
                <li><a href="https://sigmatechnology.com/media/" className="text-gray-300 hover:text-white">Media resources</a></li>
                <li><a href="https://sigmatechnology.com/content/uploads/2024/04/Code-of-Conduct-and-Business-Ethics-1.pdf?x25367" className="text-gray-300 hover:text-white">Code of conduct</a></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-700">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/sigma_technology" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
            ...
            <a href="https://www.facebook.com/sigmatechnologygroup" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              <svg width="24" height="24" viewBox="0 0 37 37" fill="currentColor">
            ...
            <a href="https://www.linkedin.com/company/sigma-technology-ab/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              <svg width="24" height="24" viewBox="0 0 37 37" fill="currentColor">
            ...
            <a href="https://www.youtube.com/user/sigmatechnologygroup" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              <svg width="24" height="24" viewBox="0 0 37 37" fill="currentColor">
