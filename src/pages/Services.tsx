  ...
  const tabContents = [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'DevOps and infrastrucuture', link: 'https://sigmatechnology.com/service/devops-by-sigma-technology-cloud/' },
      ]
    },
    {
      id: 4,
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h3 className="text-3xl font-bold text-center mb-12 text-white">Our services</h3>
        
        <div className="services-content bg-white bg-opacity-90 rounded-lg p-8 backdrop-blur-sm">
          <div className="tabs">
              ...
              {tabs.map(tab => (
                <li key={tab.id} className="mr-4">
                  <button
                    ...
                    className={`py-2 px-4 ${activeTab === tab.id ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500'}`}
                  >
                    {tab.name}
                  </button>
                </li>
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex">
                <button 
                  onClick={handlePrev}
                  className="arrow-prev p-2 mr-2 bg-gray-100 rounded-full hover:bg-gray-200"
                >
                ...
                <button 
                  onClick={handleNext}
                  className="arrow-next p-2 bg-gray-100 rounded-full hover:bg-gray-200"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            {tabContents.map(content => (
              <div 
                key={content.id} 
                className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ${activeTab === content.id ? 'block' : 'hidden'}`}
              >
